      ...
      <div class="card-stacked">
        <div class="card-content blue-grey darken-1 white-text">
            <div class="card-panel blue-grey darken-3">
                <span class="blue-text justify-content: center" style="font-size:x-large ;font-weight:bolder"><i class="small material-icons">sentiment_very_satisfied</i>Welcome Back !!!</span>
            </div>
            ...
            <h3 style="justify-content: center; font-size:x-large; font-style: oblique; padding-left:50px; padding-right:50px">You have Succesfully Logged In!!! !!! Wait,  You'll be redirected to the Home Page shortly.............</h3> 
